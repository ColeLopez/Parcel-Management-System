...
?>
    <main>
        <form action=index.php>
            <section>
                <div class="heading">Parcel List</div>
                <div class="content-wrapper">

                <?php
                    $result = mysqli_query($conn,"SELECT * FROM parcel_sa1_db.parcel_details");
                ?>
                    ...
                    <form method="POST">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="user_update_parcel.php?id=<?php echo $row["id"]; ?>">
