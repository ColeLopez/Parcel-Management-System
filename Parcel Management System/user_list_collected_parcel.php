<?php
    ...
    $_SESSION['title'] = "Collected Parcels";
...
?>
    <main>
        <section>
            <div class="heading">Collected Parcel List</div>
            <div class="content-wrapper">

            <?php
                $result = mysqli_query($conn,"SELECT * FROM parcel_sa1_db.parcel_details WHERE status_ = 'Collected'");
            ?>
