<?php
    ...
    $_SESSION['title'] = "In Transit Parcels";
...
?>
    <main>
        <section>
            <div class="heading">In Transit Parcel List</div>
            <div class="content-wrapper">

            <?php
                $result = mysqli_query($conn,"SELECT * FROM parcel_sa1_db.parcel_details where status_ = 'In Transit' ");
            ?>
