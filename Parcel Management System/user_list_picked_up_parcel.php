<?php
    ...
    $_SESSION['title'] = "Picked up Parcels";
...
?>
    <main>
        <section>
            <div class="heading">Picked up Parcel List</div>
            <div class="content-wrapper">

            <?php
                $result = mysqli_query($conn,"SELECT * FROM parcel_sa1_db.parcel_details WHERE status_ = 'Picked Up'");
            ?>
