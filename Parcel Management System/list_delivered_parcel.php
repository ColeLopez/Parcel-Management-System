<?php
    ...
    $_SESSION['title'] = "Delivered Parcels";
...
?>
    <main>
        <section>
            <div class="heading">Delivered Parcel List</div>
            <div class="content-wrapper">

            <?php
                $result = mysqli_query($conn,"SELECT * FROM parcel_sa1_db.parcel_details WHERE status_ = 'Delivered'");
            ?>
